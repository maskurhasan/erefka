                  ...
                  <div class="content table-responsive">
                    <table id="tabledata" class="table table-striped table-bordered table-hover">
                      ...
                      if($_SESSION['UserLevel']==1) {
                        ...
                        $sql= mysql_query("SELECT a.*,b.nm_Skpd,c.StatusVer,c.id_Ver,b.nm_Skpd FROM spm a, skpd b, verifikasi c
                                            WHERE a.id_Skpd = b.id_Skpd
                                            AND a.id_Spm = c.id_Spm
                      ...
                      $no=1;
                        ...
                        echo "<tr>
                                ...
                                <td>$sttver</td>
                                <td class=align-center><a class='btn btn-primary btn-sm' href='?module=verifikasi&act=add&id=$dt[id_Ver]'><i class='fa fa-edit fa-lg'></i> Proses</a>";
