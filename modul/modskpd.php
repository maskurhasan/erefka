                        ...
                        <div class="card">
                          ...
                          <div class="content table-responsive">
                            <table class="table table-bordered table-striped">
                              <thead>
                              <tr>
                                <th>Nama SKPD</th><th>Kepala SKPD</th>
                              <th></th></tr>
                              </thead>
                              <tbody>';
            ...
            <div class="card">
              ...
              echo "<form method=post class='form-horizontal' action='modul/act_modskpd.php?module=skpd&act=edit'>";
                echo '<div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="kd_Program" value="'.$r[id_Skpd].'" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Nama SKPD</label>
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="nm_Skpd" value="'.$r[nm_Skpd].'" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" type="text" name="visimisi">'.$r[visimisi].'</textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Nomor HP</label>
                    <div class="col-sm-5">
                      <input class="form-control" type="number" name="NomorHp" value="'.$r[NomorHp].'" required>
                    </div>
                  </div>
                  <!--
                  <div class="form-group">
