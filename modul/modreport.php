  ...
  switch ($_GET[act]) {
    default:
          ...
          echo '<div class="col-md-4">
              ...
              <div class="content">';
         echo "<p><button class='btn btn-md btn-info btn-fill btn-block' type=button id=id_Cetak value='rfk' onClick='ax_form_cetak(this.value)'><i class='pe-7s-note2'></i> Realisasi Fisik & Keuangan</button></p>
