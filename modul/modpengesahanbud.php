                  ...
                  <div class="content table-responsive">
                    <table id="tabledata" class="table table-striped table-bordered table-hover">
                      ...
                      if($_SESSION['UserLevel']==1) {
                        ...
                        $sql= mysql_query("SELECT a.*,b.nm_Skpd,d.nm_Lengkap,c.StatusPengbud,c.id_Ver FROM spm a, skpd b,verifikasi c, user d
                                            WHERE a.id_Skpd = b.id_Skpd
                                            AND a.id_Spm = c.id_Spm
                      ...
                      $no=1;
                        ...
                        echo "<tr>
                                ...
                                <td>$dt[nm_Skpd]</td>
                                <td>$sttver</td>
                                <td class=align-center><a class='btn btn-primary btn-sm' href='?module=pengesahanbud&act=add&id=$dt[id_Ver]'><i class='fa fa-edit fa-lg'></i> Proses Pengesahan</a>";
        ...
        echo '<div class="col-sm-12 widget-container-col">
                      ...
                      echo '<!--<div class="col-sm-12">-->
                                  ...
                                  echo '</div>
                                    ...
                                    $q1 = mysql_query("SELECT * FROM cklist WHERE Aktiv = 1");
                                    $no=1;
